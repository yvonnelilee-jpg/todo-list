...
### **CSS Strategy: Semantic Tokens**

**Style / Aesthestic : clean, simple, warm.** 

Later on :  capture the "Notebook & Washi Tape" vibe, we will use CSS variables (Design Tokens). This makes the code maintainable and allows for easy "theming" later.
